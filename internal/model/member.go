...
type Member struct {
	...
	CreateDate string `gorm:"column:create_data; type:char(20); comment:'加入时间'"`
...
type Like_Status struct {
	...
	Member_Like   Member `gorm:"foreignKey:MemberId_Like;references:ID"`
	Member_BeLike Member `gorm:"foreignKey:MemberId_BeLike;references:ID"`
}
