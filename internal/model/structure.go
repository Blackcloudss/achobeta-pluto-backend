...
type Structure struct {
	...
	MyselfId   int64  `gorm:"column:myself_id;   type:bigint; index;not null; comment:'当前节点ID'"`
	FatherId   int64  `gorm:"column:father_id;   type:bigint; index;not null; comment:'父节点ID'"`
