...
type Casbin struct {
	CommonModel
	Ptype string `gorm:"column:ptype;type:char(2);index:idx_casbin;not null;comment:'权限类型'"`
	V0    int64  `gorm:"column:v0;type:bigint;index:idx_casbin;not null;comment:'用户ID'"`
	V1    int64  `gorm:"column:v1;type:bigint;index:idx_casbin;not null;comment:'团队ID'"`
